 ...
 */
public class GreaterClauseUnitTest {

    private GreaterClause clause = new GreaterClause("temperature", "10");
    ...
    public void test_insect(){
        ...
        assertThat(clause.intersect(new GEClause("temperature", "12"))).isEqualTo(IntersectionType.Inclusive);
